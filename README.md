# Telia Scenario Plan Researcher and Product Development Recommendation Report Generator

This project generates reports recommending web product development strategies for Telia over a 2-year horizon, based on AI-driven web evolution scenarios. The scenarios were originally generated by Gemini 2.5 Pro.
...
3.  **Install dependencies:**
    Install the project requirements using your chosen package manager within the activated virtual environment.
...
Once the environment is set up and configured, you can generate a Telia-specific report by running:
```bash
python run_research.py
```
The output report will be generated based on the logic within `run_research.py` and the configurations in your `.env` file.
